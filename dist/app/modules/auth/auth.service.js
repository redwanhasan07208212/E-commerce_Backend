...
const loginUser = (payLoad) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_model_1.User.isUserExistByCustomId(payLoad === null || payLoad === void 0 ? void 0 : payLoad.email);
    if (!user) {
    ...
    const matchedPassword = yield bcrypt_1.default.compare(payLoad.password, user.password);
    if (!matchedPassword) {
